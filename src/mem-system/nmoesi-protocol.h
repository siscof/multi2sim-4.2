...
extern int EV_MOD_NMOESI_LOAD_SEND;
extern int EV_MOD_NMOESI_LOAD_RECEIVE;
extern int EV_MOD_NMOESI_LOAD_LOCK;
extern int EV_MOD_NMOESI_LOAD_LOCK2;
...
extern int EV_MOD_NMOESI_NC_LOAD;
extern int EV_MOD_NMOESI_NC_LOAD_SEND;
extern int EV_MOD_NMOESI_NC_LOAD_RECEIVE;
extern int EV_MOD_NMOESI_NC_LOAD_LOCK;
extern int EV_MOD_NMOESI_NC_LOAD_ACTION;
extern int EV_MOD_NMOESI_NC_LOAD_MISS;
extern int EV_MOD_NMOESI_NC_LOAD_UNLOCK;
extern int EV_MOD_NMOESI_NC_LOAD_FINISH;

extern int EV_MOD_NMOESI_STORE;
extern int EV_MOD_NMOESI_STORE_SEND;
extern int EV_MOD_NMOESI_STORE_RECEIVE;
...
extern int EV_MOD_NMOESI_NC_STORE_SEND;
extern int EV_MOD_NMOESI_NC_STORE_RECEIVE;
extern int EV_MOD_NMOESI_NC_STORE_LOCK;
extern int EV_MOD_NMOESI_NC_STORE_LOCK2;
...
extern int EV_MOD_NMOESI_EVICT_CHECK;
extern int EV_MOD_NMOESI_EVICT_LOCK_DIR;
